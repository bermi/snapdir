...
2026-05-31T01:23:22Z gate=ci-config owner=ci verdict=pass git=<pending-commit> evidence=.gatesmith/evidence/ci-config-2026-05-31T01:23:22Z.log note=ci.yaml(lint/deny/test-matrix+musl/coverage/semver)+deny.toml(aws-lc-rs banned)+_typos.toml authored; actionlint clean exit0
